...
<body class="antialiased">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex">
                            <div class="flex items-center me-4">
                                <input id="autoRadioButton" type="radio" value="" name="inline-radio-group" checked
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="inline-radio"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Auto</label>
                            </div>
                            <div class="flex items-center me-4">
                                <input id="manualRadioButton" type="radio" value="" name="inline-radio-group"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    ...
                    <div id="manualRadio">
                        ...
                        <div class="mb-6">
                            <div class="relative max-w-sm">
                                ...
                                <input type="time" id="start" name="start" class="" min="09:00" max="18:00">
    ...
    <script>
        // const manualRadioButton = document.getElementById("manualRadioButton");
        // const dateTimeDiv = document.querySelector("manualRadio");

        // manualRadioButton.addEventListener("change", () => {
        //     if (manualRadioButton.checked) {
        //         dateTimeDiv.style.display = "block"; // Show the div
        //     } else {
        //         dateTimeDiv.style.display = "none"; // Hide the div
        //     }
        // });
